...
public class PaymentGatewayClientTest {
    ...
    private DropOffPaymentGateway paymentRequest;
    ...
    public void testChargeCreditCard_FailedPayment() {
        ...
        // Act & Assert
        assertThrows(CustomPaymentException.class, () -> paymentGatewayClient.chargeCreditCard(paymentRequest));
    }
    ...
    private DropOffPaymentGateway createPaymentRequest() {
    ...
    private DropOffPaymentResponse createExpectedResponse() {
