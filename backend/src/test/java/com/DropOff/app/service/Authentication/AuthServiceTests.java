...
import com.DropOff.app.service.Authentication.ForgotPasswordTokenService;
import com.DropOff.app.service.Authentication.JwtTokenService;
...
public class AuthServiceTests {
    ...
    public void registerTestUserAlreadyExist() {
        authService = Mockito.spy(new AuthenticationServiceImpl());
