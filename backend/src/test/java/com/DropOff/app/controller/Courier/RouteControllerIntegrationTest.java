...
public class RouteControllerIntegrationTest {
    ...
    private Routes createDriverRoute(String driverId, String sourceCity, String sourceCityReferenceId,
    ...
    public void testCreateDriverRoute() throws Exception {
       ...
       // Date date = format.parse("2023-05-01");
        Routes driverRoute = createDriverRoute(
