package com.DropOff.app.DropOff_Sockets;
...
public class InboxChatSocket {

    private InboxChatSocket chatSocketHandler;
    ...
    @Before
    public void setUp() {
        chatSocketHandler = InboxChatSocket.getInstance();
    ...
    public void testHandleTextMessage() throws Exception {
        ...
        Mockito.when(chatSession.getUri()).thenReturn(URI.create("ws://localhost:8080/chat/"+ TestConstants.USER_ONE_ID + InboxChatSocket.ID_SPLITTER + TestConstants.USER_TWO_ID));
    ...
    public void testGetSendingUniqueID() {
        String expected = TestConstants.USER_ONE_ID + InboxChatSocket.ID_SPLITTER + TestConstants.USER_TWO_ID;
        String actual = chatSocketHandler.getSendingUniqueID(session);
        assertEquals(expected, actual);
    }
    
    private String mockUniqueId() {
        return TestConstants.USER_TWO_ID + InboxChatSocket.ID_SPLITTER + TestConstants.USER_ONE_ID;
    }
}
