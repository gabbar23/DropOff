...
public class Const {
    ...
    public static final String[] AUTH_EXCEPT_PATHS = {"/" ,"/register", "/verification", "/changepassword", "/forgotpassword", "/login", "/driverRoutes", "/DropOffPay", "/chatSocket/*", "notificationSocket/*"};
}
